...
###################################################################
####
#### after running GEMMA using the commands generated by script 1.03_input_GWAS (GEMMA_commands.sh)
#### run this script for each trait
####
#### for each environment:
#### - generate manhattan plot
#### - generate QQ plot
#### - write list of significant haplotypes
####
...
# output folder
dir.create(paste(TRAIT, "/summary_GWAS", sep =""))
outfolder <- paste(TRAIT, "/summary_GWAS", sep ="")

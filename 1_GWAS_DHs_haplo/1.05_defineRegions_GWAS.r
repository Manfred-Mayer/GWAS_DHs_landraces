...
#### based on the significant haplotypes identified in GWAS,
#### define trait associated regions, grouping haplotypes together which
...
# input folder
infolder <- paste(TRAIT, "/summary_GWAS", sep ="")
infolder

# output folder
dir.create(paste(TRAIT, "/QTLregs", sep = ""))
outfolder <- paste(TRAIT, "/QTLregs", sep = "")
outfolder

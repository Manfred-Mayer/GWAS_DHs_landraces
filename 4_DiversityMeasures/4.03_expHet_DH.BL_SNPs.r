...
save(expHet, file = paste(outfolder, "/expHet_", LR, ".RData", sep = ""))
info_expHet_avg[LR, "expHet"] <- expHet$expHet_avg
write.table(info_expHet_avg, file = paste0(outfolder, "/info_expHet_avg.csv"), sep = ";", dec = ".", quote = FALSE, col.names = FALSE, row.names = TRUE)
...
str(geno)
expHet <- expHet_f(geno)
save(expHet, file = paste(outfolder, "/expHet_DHall.RData", sep = ""))
...
str(geno)
expHet <- expHet_f(geno)
save(expHet, file = paste(outfolder, "/expHet_BLs.RData", sep = ""))
